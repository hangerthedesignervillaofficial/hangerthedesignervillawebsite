...
export default function AdminProductsPage() {
  ...
  const handleCreateProduct = async (productData: CreateProductData) => {
    try {
      ...
      toast.error("Failed to create product: " + ((error as any)?.message || (error as any)?.toString() || "Unknown error"));
    }
  };
  ...
  const handleUpdateProduct = async (
    ...
    try {
      ...
      toast.error("Failed to update product: " + ((error as any)?.message || (error as any)?.toString() || "Unknown error"));
    }
  };
  ...
  const handleDeleteProduct = async (productId: string) => {
    try {
      ...
      toast.error("Failed to delete product: " + ((error as any)?.message || (error as any)?.toString() || "Unknown error"));
    }
  };
