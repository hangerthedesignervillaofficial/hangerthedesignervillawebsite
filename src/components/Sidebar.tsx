...
export default function Sidebar() {
  ...
  return (
    ...
    >
      <SidebarContent className="relative bg-[#F7F2EC] text-[#2C1810] flex flex-col justify-between h-full min-h-screen overflow-y-auto scrollbar-none p-5 sm:p-6 z-10 select-none">
